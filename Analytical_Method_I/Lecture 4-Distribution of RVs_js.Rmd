...
#        I think that caused by the data sampled bias. for example,
#        The age histgram shows different right skewness. The skewed sample people's ages will effect on other varaibles.
...
qqnorm(fdims$kne.di)
qqline(fdims$kne.di)
hist(fdims$kne.di, main = "Histogram Female Knee diameter", xlab = "Female Knee")
...
qqnorm(fdims$elb.di)
qqline(fdims$elb.di)
hist(fdims$elb.di, main = "", xlab = "Female elbow diameter");

D
qqnorm(fdims$age)
qqline(fdims$age)
hist(fdims$age, main = "", xlab = "Female age");
